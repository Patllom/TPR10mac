...
สถานะ: แนวทางในบทสนทนาได้รับอนุมัติแล้ว; เอกสารฉบับนี้รอผู้ใช้ตรวจทานก่อนจัดทำ Implementation Plan
...
รายละเอียดเชิงนโยบายที่ระบุเพิ่มในเอกสารนี้ เช่น การห้ามมอบหมายสิทธิ์ให้ตนเองและขอบเขตหน้าจอ ถือเป็นข้อเสนอสำหรับการตรวจเอกสาร ไม่อ้างว่าผู้ใช้อนุมัติรายละเอียดเหล่านี้ไปแล้ว
